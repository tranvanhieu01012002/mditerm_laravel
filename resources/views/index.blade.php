...
<body>
    ...
    @endif
        <a href="{{route('vegetable.create')}}" class="btn btn-primary tm-btn-prev mb-2 ">ADD new product</a>
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end ">
                <form action="" class="tm-text-primary">
                    Xem the loai: 
                    <a href=" {{route('vegetable.index')}} "> tat ca | </a>
                    @isset($pros)
                    @foreach ($pros as $catogory) 

                        <a href=" {{route('indexCategory',$catogory->id)}} "> {{$catogory->name}} | </a>
                    @endforeach
                @endisset
                </form>
            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                    <figure class="effect-ming tm-video-item">
                        ...
                        <figcaption class="d-flex align-items-center justify-content-center">
                            ...
                            <a href=" {{route('vegetable.show',$vegetable->id)}} ">View more</a>
                        </figcaption>                    
                    </figure>
                    <div class="d-flex justify-content-between tm-text-gray">
                        <span class="tm-text-gray-light">Gia cu:{{$vegetable->old_price}}</span>
                        <span>Gia moi: {{$vegetable->new_price}}</span>
                    </div>
                </div>
                @endforeach
            @endisset
